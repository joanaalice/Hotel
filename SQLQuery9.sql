...
RESERVAID INT CONSTRAINT fk_ROOM_RESERVATION NULL
...
DATAVALIDADE DATETIME CHECK (DATAVALIDADE < GETDATE()) NOT NULL,
DATACADASTRO DATETIME DEFAULT GETDATE() NOT NULL,
CATEGORIAID INT NOT NULL CONSTRAINT FK_PRODUCTS_CATEGORIES 
...
(
	ID INT PRIMARY KEY IDENTITY,
	DATA_CADASTRO DATETIME DEFAULT GETDATE() NOT NULL,
	FUNCIONARIOID INT CONSTRAINT fk_PRODUCT_ENTRY_USER
         FOREIGN KEY REFERENCES Users(ID),
...
(
	ID INT PRIMARY KEY IDENTITY,
	PRODUTOID INT NOT NULL CONSTRAINT FK_PRODUCT_ITEM 
FOREIGN KEY REFERENCES Products(ID),
	QUANTIDADE INT NOT NULL, 
	CUSTO FLOAT NOT NULL,
	PRODUCT_ENTRYID INT NOT NULL CONSTRAINT FK_PROUCT_ENTRY
FOREIGN KEY REFERENCES Product_Entry(ID),
	PROVIDERID INT NOT NULL CONSTRAINT FK_ENTRYITEM_PROVIDER
FOREIGN KEY REFERENCES Providers(ID),
	DATA_CADASTRO DATETIME DEFAULT GETDATE() NOT NULL,
	ATIVO BIT DEFAULT 1 NOT NULL,
)
...
(
	ID INT IDENTITY,
	PRODUCTID INT NOT NULL CONSTRAINT FK_PRODUCT_PROVIDERS 
FOREIGN KEY REFERENCES Products(ID),
	PROVIDERID INT NOT NULL CONSTRAINT FK_PROVIDER_PRODUCTS
FOREIGN KEY REFERENCES Providers(ID),
)
...
(
	...
	VALOR FLOAT NOT NULL,
	CLIENTEID INT NOT NULL CONSTRAINT FK_CLIENT_PRODUCT_SALE 
FOREIGN KEY REFERENCES Customers(ID),
	USERID INT NOT NULL CONSTRAINT FK_USER_PRODUCT_SALE 
FOREIGN KEY REFERENCES Users(ID)
)
...
(
	ID INT PRIMARY KEY IDENTITY,
	PRODUCTID INT NOT NULL CONSTRAINT FK_PRODUCT_SALE_ITEM 
FOREIGN KEY REFERENCES Products(ID),
	QUANTIDADE INT NOT NULL, 
	VENDAID INT NOT NULL CONSTRAINT FK_SALE_SALE_ITEMS 
FOREIGN KEY REFERENCES Product_Sale(ID),
	ATIVO BIT DEFAULT 1 NOT NULL,
)